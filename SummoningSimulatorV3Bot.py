...
async def help():
    ...
    embed.add_field(name = "fcrarity", value = 'Summons continuously until a specified amount of foods souls with a specified rarity has been summoned.', inline = False)
