...
async def help():
    ...
    embed.add_field(name = "f!summon <amount>", value = "Summons a desired amount of food souls from the current summoning pool.\\nExample: f!summon 100 will summon 100 food souls from the current summoning pool.", inline = False)
    embed.add_field(name = "f!foodsoul <food_soul> <amount>", value = 'Summons endlessly until a specific food soul of a specified amount has been summoned. Use "." instead of spaces.\nExample: f!foodsoul Bamboo.Rice 2 will summon endlessly until two Bamboo Rice have been summoned.', inline = False)
    ...
    embed.add_field(name = "f!efoodsoul <event_index> <food_soul> <amount>", value = 'Event summoning! Summon endlessly from an event until a specific food soul of a specified amount has been summoned. Use f!eventindex to check the event index.\nExample: f!event 2 foodsoul sweet.tofu 2 will summon endlessly during the "Brewing Fine Wine" event until it summons 2 Sweet Tofu.', inline = False)
...
##@commands.cooldown(1, 3, commands.BucketType.user)
##async def soulinfo(soul):
##    lsoul = soul.lower()
##    if lsoul in lsummon_pool or lsoul in lnone_pool or lsoul in levent_pool or lsoul in lunre_pool or lsoul in lcevent_pool:
##        pass
