...
@commands.cooldown(1, 30, commands.BucketType.user)
async def update():
    updatelist = [["Added summoning event: Savory Feast", "You can now summon Ddeokbokki and Kimchi from the new event! After the event ends, Ddeokbokki and Kimchi will be added to the summoning pool."],
