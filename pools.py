...
nur_pool = ["White Truffle", "Turducken", "Oyster", "Fruit Tart", "Matsutake Dobinmushi", "Cloud Tea", "Canele", "Pizza", "Apple Pie", "Nagashi Somen", "Mapo Tofu"]
nsr_pool = ["Pretzel", "Marshmallow", "Soba", "Margarita", "Borscht", "Black Tea", "Lion's Head", "American Corn Bread", "Eggnog", "Zitui Bun", "Salty Tofu", "Spaghetti", "Donut", "Tortoise Jelly", "Sweet & Sour Fish", "Beggar's Chicken", "Bloody Mary", "Vodka", "Wonton", "Yogurt", "Surstromming"]
...
eur_pool = ["Whisky", "Dragon & Phoenix", "Stargazy Pie", "Osechi", "Buddha's Temptation", "Turkey", "Butter Tea", "Huangshan Maofeng Tea", "Champagne", "Sichuan Hotpot", "Toso", "Raindrop Cake", "Milt", "Caviar"]
esr_pool = ["Waffle", "Realgar Wine", "Qingtuan", "Mung Bean Soup", "Black Pudding", "Unadon", "Mandarin Squirrel Fish", "Green Curry", "Cassata", "Bonito Rice", "Seaweed Soup", "Beer", "Moon Cake", "Sushi", "Osmanthus Cake", "Fondant Cake"]
